Feature: Loan Calculator Testing In Chrome Browser
	
	# This feature tests the loan calculator functionalities in the Chrome browser, including car loans, home loans, and EMI calculations.
